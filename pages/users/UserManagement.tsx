      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Assign system permissions and manage staff access levels.
          </p>
        </div>
        <button
              ...
              {users.map((user) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      <div
                        className={`inline-flex items-center px-3 py-1.5 rounded-xl border ${style.bg} ${style.text} ${style.border} transition-all duration-300`}
                      >
                        <span
                          className={`w-1.5 h-1.5 ${style.dot} rounded-full mr-2 shadow-sm`}
                        ></span>
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-3xl text-white shadow-xl shadow-slate-200 relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <p className="text-slate-300 text-sm opacity-90 leading-relaxed mb-6">
              Roles define what data modules a user can access. Super Admins can
              override all restrictions. Ensure doctors only have access to
              patient records for confidentiality.
            </p>
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Track all role modification activities.
              </p>
            </div>
          </div>
          <p className="text-sm text-slate-600 mb-4 leading-relaxed">
            Total of 24 role changes were made in the last 30 days by Super
            Admin. All changes are logged for HIPAA compliance.
          </p>
            ...
            <form onSubmit={handleInviteSubmit} className="p-8 space-y-6">
              ...
              <div className="bg-sky-50 p-4 rounded-2xl border border-sky-100">
                <p className="text-[10px] text-sky-700 font-bold leading-relaxed">
                  An invitation link will be sent to the email provided. The
                  user will be prompted to set their credentials and complete
                  their profile upon clicking the link.
                </p>
              </div>
              <button
                type="submit"
